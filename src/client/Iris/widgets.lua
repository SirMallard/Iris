...
do -- Iris.SliderNum
    ...
    local function updateActiveSlider()
        ...
        local PositionRatio = (UserInputService:GetMouseLocation().X - (InputFieldContainer.AbsolutePosition.X + GrabPadding)) / (InputFieldContainer.AbsoluteSize.X - 2 * GrabPadding)
    ...
    UserInputService.InputChanged:Connect(updateActiveSlider)
    ...
    Iris.WidgetConstructor("SliderNum", {
        ...
        Generate = function(thisWidget)
            ...
            if Iris._config.GrabRounding > 0 then
                UICorner(GrabBar, Iris._config.GrabRounding)
            end
