...
API.Window = function(title: string, flags: number?, size: Types.State<Vector2>?, position: Types.State<Vector2>?, open: Types.State<boolean>?, shown: Types.State<boolean>?, scrollDistance: Types.State<number>?)
    return Internal._insert("Window", title, flags or 0, size, position, open, shown, scrollDistance) :: Window.Window
end
...
API.SetFocusedWindow = Window.setFocusedWindow
...
API.Tooltip = function(text: string)
    return Internal._insert("Tooltip", text) :: Window.Tooltip
end
