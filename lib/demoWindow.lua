...
local widgetDemos = {
    Basic = function()
        ...
        do
            ...
            Iris.SameLine()
            do
                Iris.RadioButton(ndex , radioButtonStat)
                Iris.RadioButton(ndex 'tw, radioButtonStat)
    ...
    Input = function()
        ...
        do
            ...
            local InputNum = Iris.InputNum("Input Number", Increment._value, Min._value, Max._value, { Format._value }
...
local function tablesDemo()
    ...
    if showTablesTree._value == false then
        ...
        do
            ...
            -- fix this
            Iris.Table(3, (Header._value and Iris.TableFlags.Header) + (RowBackgrounds._value and Iris.TableFlags.RowBackground) + (OuterBorders._value and Iris.TableFlags.OuterBorders) + (InnerBorders._value and Iris.TableFlags.InnerBorders) )
            do
        ...
        do
            ...
            Iris.Checkbox( "Resizable", Resizable )
            Iris.Checkbox( "Limit Table Width", LimitWidth )

            do
                Iris.SeparatorText( "stretch, equal" )
                -- fix this
                Iris.Table( 3, false, true, true, true, Resizable._value )
                do
                    for _ = 1, 3 do
                        for _ = 1, 3 do
                            Iris.Text( "stretch" )
            ...
            do
                ...
                Iris.Table({ 3, false, true, true, true, Resizable._value, false, true })
                do
                    for _ = 1, 3 do
                        for _ = 1, 3 do
                            Iris.Text( "stretch" )
            ...
            do
                ...
                Iris.Table({ 3, false, true, true, true, Resizable._value, true, false, LimitWidth._value })
                do
                    for _ = 1, 3 do
                        for _ = 1, 3 do
                            Iris.Text( "fixed" )
            ...
            do
                ...
                Iris.Table({ 3, false, true, true, true, Resizable._value, true, true, LimitWidth._value })
                do
                    for _ = 1, 3 do
                        for _ = 1, 3 do
                            Iris.Text( "fixed" )
        ...
        do
            ...
            Iris.Table({ 3 })
            do
                Iris.Checkbox( "Show Header Row", HeaderState )
                Iris.NextColumn()
                Iris.Checkbox( "Show Row Backgrounds", BackgroundState )
                Iris.NextColumn()
                Iris.Checkbox( "Show Outer Border", OuterBorderState )
                Iris.NextColumn()
                Iris.Checkbox( "Show Inner Border", InnerBorderState )
                Iris.NextColumn()
                Iris.Checkbox( "Resizable", ResizableState )
                Iris.NextColumn()
                Iris.Checkbox( "Fixed Width", FixedWidthState )
                Iris.NextColumn()
                Iris.Checkbox( "Proportional Width", ProportionalWidthState )
                Iris.NextColumn()
                Iris.Checkbox( "Limit Table Width", LimitTableWidthState )
                Iris.NextColumn()
            ...
            for i = 1, NumColumns._value do
                local increment = if FixedWidthState._value == true then 1 else 0.05
                local min = if FixedWidthState._value == true then 2 else 0.05
                local max = if FixedWidthState._value == true then 480 else 1
                Iris.SliderNum(`Column {i} Width`, increment, min, max, nil, 
            ...
            Iris.Table(
                { NumColumns._value, HeaderState._value, BackgroundState._value, OuterBorderState._value, InnerBorderState._value, ResizableState._value, FixedWidthState._value, ProportionalWidthState._value, LimitTableWidthState._value },
                { widths = WidthState }
            )
            do
                Iris.SetHeaderColumnIndex(1)
...
return function()
    ...
    if showMainWindow._value == false then
        Iris.Checkbox({ "Open main window" }, { check = showMainWindow })
        return
    end
    ...
    local window = Iris.Window(
        "Iris Demo Window",
        [Iris.Args.Window.NoTitleBar] = NoTitleBar._value,
        [Iris.Args.Window.NoBackground] = NoBackground._value,
        [Iris.Args.Window.NoCollapse] = NoCollapse._value,
        [Iris.Args.Window.NoClose] = NoClose._value,
        [Iris.Args.Window.NoMove] = NoMove._value,
        [Iris.Args.Window.NoScrollbar] = NoScrollbar._value,
        [Iris.Args.Window.NoResize] = NoResize._value,
        [Iris.Args.Window.NoNav] = NoNav._value,
        [Iris.Args.Window.NoMenu] = NoMenu._value,
    ...
    if window.state.isUncollapsed._value and window.state.isOpened._value then
        ...
        do
            Iris.Table( 3 )
            do
                Iris.Checkbox("NoTitleBar", NoTitleBar)
                Iris.NextColumn()
                Iris.Checkbox("NoBackground", NoBackground)
                Iris.NextColumn()
                Iris.Checkbox("NoCollapse", NoCollapse)
                Iris.NextColumn()
                Iris.Checkbox("NoClose", NoClose)
                Iris.NextColumn()
                Iris.Checkbox("NoMove", NoMove)
                Iris.NextColumn()
                Iris.Checkbox("NoScrollbar", NoScrollbar)
                Iris.NextColumn()
                Iris.Checkbox("NoResize", NoResize)
                Iris.NextColumn()
                Iris.Checkbox("NoNav", NoNav)
                Iris.NextColumn()
                Iris.Checkbox("NoMenu", NoMenu)
                Iris.NextColumn()
            end
            Iris.End()
        end
